...
public class Neo4jDialog extends Dialog {
	...
	private Set<String> preOutputColumnSet = new HashSet<>();
	...
	public Neo4jDialog(Shell parentShell, Neo4jMain neo4jMain) {
		...
		setShellStyle(getShellStyle() | SWT.DIALOG_TRIM | SWT.MIN | SWT.MAX
	...
	protected void okPressed() {
		...
		IComponent iComponent = neo4jMain.getNeo4jManager().getNeo4jComponent()
				.getComponent();
		...
		if (!"tNeo4jOutput".equals(componentName)) {
			List<? extends IConnection> connection = neo4jMain
					.getNeo4jManager().getNeo4jComponent()
			...
			if (curConnection != null) {
				...
				changedNameColumns = neo4jMain.getNeo4jUI()
						.getChangedNameColumns();
				...
				CorePlugin
						...
						.updateTraceColumnValues(curConnection,
								changedNameColumns, addedColumns);
			}
		}
	}
